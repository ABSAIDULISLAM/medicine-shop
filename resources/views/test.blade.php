                            ...
                            <div class="col-md-3">
                                        ...
                                        <select name="supplier_id" id="supplier_id" class="form-control select2" required="">
                                            <option value="">Select Supplier</option>
                                                                                                <option value="1259" ></option>
                                                                                                        ...
                                                                                                        <option value="1265" >asd</option>
                                                                                                        <option value="1262" >asdf</option>
                                                                                                        <option value="1263" >asdf</option>
                                                                                                        <option value="1266" Selected>asdf</option>
                                                                                                        <option value="1264" >asdf vasf</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="final_amount" id="invoice_amount" class="form-control" value="0.00" placeholder="0.00" readonly="">
                                        <input type="hidden" id="hiddenInvoiceAmount" class="form-control" value="0.00" placeholder="0.00" readonly="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="payment" class="form-control" id="payment" oninput="paymentAmount(this.id)" value="0.00" placeholder="0.00" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                        <input type="text" name="previous_dues" id="previous_dues" class="form-control" autocomplete="off" value="0.00" required="" placeholder="0.00" readonly="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                        <input type="text" name="discount" class="form-control" id="discount" oninput="discountAmount(this.id)" value="0.00" placeholder="0.00" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                        <input type="text" class="form-control" name="dues" id="dues"  placeholder="0.00" value="0.00" autocomplete="off" readonly="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice_number" id="invoice_number" class="form-control" value="17164452941" autocomplete="off" required="" readonly="">
                                        <input type="hidden" name="id" class="form-control" value="1077" autocomplete="off" required="" readonly="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                        <input type="text" name="shipping_charge" class="form-control" id="shipping_charge" oninput="shippingAmount(this.id)" value="0.00" placeholder="0.00" autocomplete="off">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="date" name="date" class="form-control pull-right" value="2024-05-23" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="payment_method" id="payment_method" class="form-control" onchange="change()" required="" style="width: 100%;">
                                ...
                                <div class="form-group" id="cheque_no" style="display: none">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                                        <input type="text" name="cheque_no" class="form-control" id="cheque_number" value="" placeholder="Cheque Number" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div style="overflow-x:auto;">
                                    <table class="table tbl table-bordered table-striped table-hover">
                                        ...
                                        <tbody id="tbody">
                                                                                                    <tr id="R1">
                                                        <td class="row-index text-center" style="width: 10px"><p>1</p></td>
                                                        <td class="text-left" style="width: 150px;">Asiclin 300<br/>300mg                                                                <input type="hidden" name="product_id[]" value="18616" class="form-control  productId">
                                                            <input type="hidden" name="invoice_id[]" value="35" class="form-control  invoice_id">
                                                            <input type='hidden' value="35" name='invoiceRowId[]'>
                                                        </td>

                                                        <td class="text-center" style="width: 70px;">
                                                            <input type="text" name="quantity[]" value="1.00" class="form-control cl_qty" style="width:100%;" autocomplete="off">

                                                        </td>
                                                        <td class="text-right" style="width: 80px;">
                                                            <input type="text" name="cost_price[]" value="0.00" class="form-control unitPrice" style="width:100%;text-align: center" autocomplete="off">
                                                        </td>
                                                        <td class="text-right" style="width: 80px;">
                                                            <input type="text" name="sales_price[]" value="0.00" class="form-control sales_price" style="width:100%;text-align: center" autocomplete="off">
                                                        </td>
                                                        <td class="text-right" style="width: 80px;">
                                                            <input type="date" name="expire_date[]" value="2022-04-30" class="form-control exp_date" style="width:145px;text-align: center;margin-right: -25px" autocomplete="off">
                                                        </td>
                                                        <td class="text-right" style="width: 80px;">
                                                            <select name="rack_id[]" class="form-control rack_id" style="width:100%;text-align: center;color: red;font-weight: bold"> <option value="2"  ></option>  <option value="3"  >Rack3</option>  <option value="4"  >Rack4</option>  <option value="5"  >Rack5</option>  <option value="6"  >Rack6</option>  <option value="7"  >Rack7</option>  <option value="8"  >Rack8</option>  <option value="9"  >Rack9</option>  <option value="13"  >Rack13</option>  <option value="14"  >Rack14</option>  <option value="15"  >Rack15</option>  <option value="16"  >Rack16</option>  <option value="17"  >Rack17</option>  <option value="18"  >Rack18</option>  <option value="19"  >Rack19</option>  <option value="20"  >Rack20</option>  <option value="21"  >Rack21</option>  <option value="22"  >Rack22</option>  <option value="23"  >Rack23</option>  <option value="24"  >Rack24</option>  <option value="25"  >Rack25</option>  <option value="26"  >Rack26</option>  <option value="27"  >Rack27</option>  <option value="28"  >Rack28</option>  <option value="29"  >Rack29</option>  <option value="30"  ></option>  <option value="31"  >Rack1</option> </select>
                                                        </td>
                                                        <td class="text-right" style="width: 100px;">
                                                            <input type="text" value="0.00" name="sub_total[]" tabindex="1" class="form-control proPrice" style="width:100%;text-align: center" autocomplete="off">
                                                            <input type="hidden" value="0.00" name="hiddnTotal[]" tabindex="1" class="form-control hiddnTotal" style="width:100%;text-align: center" readonly="">
                                                        </td>
                                                        <td class="text-right">
                                                            <input type="text" name="inStock[]" value="1" tabindex="1" class="form-control inStock" style="width:100%;text-align: center" readonly="">
                                                            <input type="hidden" value="2" name="preStock[]" tabindex="1" class="form-control preStock" style="width:100%;text-align: center" readonly="">
                                                        </td>
                                                        <td class="text-center" style="width: 50px;">
                                                            ...
                                                            <tr id="R2">
                                                        <td class="row-index text-center" style="width: 10px"><p>2</p></td>
                                                        <td class="text-left" style="width: 150px;">Asfen<br/>1 mg/5 ml                                                                <input type="hidden" name="product_id[]" value="18171" class="form-control  productId">
                                                            <input type="hidden" name="invoice_id[]" value="36" class="form-control  invoice_id">
                                                            <input type='hidden' value="36" name='invoiceRowId[]'>
                                                        </td>
                                                        ...
                                                        <td class="text-center" style="width: 50px;">
                                                            ...
                                                            <tr id="R3">
                                                        <td class="row-index text-center" style="width: 10px"><p>3</p></td>
                                                        <td class="text-left" style="width: 150px;">Fast PLUS<br/>500mg + 65mg                                                                <input type="hidden" name="product_id[]" value="18911" class="form-control  productId">
                                                            <input type="hidden" name="invoice_id[]" value="37" class="form-control  invoice_id">
                                                            <input type='hidden' value="37" name='invoiceRowId[]'>
                                                        </td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="center" style="width:120px">
                                                    <input type="text" class="form-control totalAmount" id="totalAmount" name="total_amount" value="0.00" style="width: 100%;color: red;font-weight:bold;text-align: center" readonly>
                                                    <input type="hidden" class="form-control hiddenTotalAmount" id="hiddenTotalAmount" value="0.00" readonly>
