                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" >{{$item->withdraw_amount}}</td>
                                        <td class="text-left" >{{$item->remarks}}</td>
                                        <td class="text-center" style="width: 100px">
                                        <button
                                            onclick="editModal( '{{$item->id}}','{{$item->bank_id}}','{{$item->date}}','{{$item->withdraw_amount}}','{{$item->remarks}}' )"
                                            class="btn red-meadow" style="background-color: #006666">
                                            <i class="fa fa-pencil" style="color: #fff"></i>
                                        </button>
                                        <a href="{{ route('Account.bank.withdraw.delete', Crypt::encrypt($item->id)) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('Account.bank.withdraw.store')}}">
                        @csrf
                        ...
                        <br />
                        <label>Withdrawal Amount <span style="color: red">*</span></label>
    ...
    <div id="edit" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('Account.bank.withdraw.update')}}">
                        @csrf
                        <label>Bank Name  <span style="color: red">*</span></label>
