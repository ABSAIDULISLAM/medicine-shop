        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="">
                    ...
                    <input type="text" name="withdraw_amount" class="form-control" placeholder="Withdraw Amount" autocomplete="off"/>
                    <br />
                    <label>Remakrs </label>
                    <input type="text" name="remarks" class="form-control" placeholder="Remakrs" autocomplete="off"/>
                    <br />
