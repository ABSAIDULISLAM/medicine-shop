...
@section('content')
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-left" >{{$item->rack_name}}</td>
                                        <td>
                                        ...
                                        <button
                                            onclick="editModal('{{ $item->id }}', '{{ $item->rack_name }}','{{ $item->status }}' )"
                                            class="btn red-meadow" style="background-color: #006666">
                                            <i class="fa fa-pencil" style="color: #fff"></i>
                                        </button>
                                        <a href="{{ route('Settings.rack.delete', Crypt::encrypt($item->id)) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('Settings.rack.update')}}">
                        @csrf
    ...
    <script>
        function editModal(id, gname, status ) {
            ...
            $('#edit').find('input[name="rack_name"]').val(gname);
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('Settings.rack.store')}}">
                        @csrf
                        <label>Rack Name</label>
