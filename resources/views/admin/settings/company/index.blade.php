...
@section('content')
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button
                                            onclick="editModal('{{ $item->id }}', '{{ $item->company_name }}','{{ $item->status }}' )"
                                            class="btn red-meadow" style="background-color: #006666">
                                            <i class="fa fa-pencil" style="color: #fff"></i>
                                        </button>
                                        <a href="{{ route('Settings.company.delete', Crypt::encrypt($item->id)) }}"
    ...
    <script>
        function editModal(id, gname, status ) {
            ...
            $('#edit').find('input[name="company_name"]').val(gname);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('Settings.company.store')}}">
                        ...
                        <input type="text" name="company_name" class="form-control" placeholder="Generic Name" />
                        <br />
                        <label>Select status</label>
                        <select name="status" id="gender" class="form-control">
