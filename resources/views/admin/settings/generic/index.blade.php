...
@section('content')
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button
                                            onclick="editModal('{{ $item->id }}', '{{ $item->generic_name }}','{{ $item->status }}' )"
                                            class="btn red-meadow" style="background-color: #006666">
                                            <i class="fa fa-pencil" style="color: #fff"></i>
                                        </button>
                                        <a href="{{ route('Settings.generic.delete', Crypt::encrypt($item->id)) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('Settings.generic.update')}}">
                        @csrf
    ...
    <script>
        function editModal(id, gname, status ) {
            ...
            $('#edit').find('input[name="generic_name"]').val(gname);
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('Settings.generic.store')}}">
                        @csrf
                        <label>Generic Name</label>
