            ...
            <div class="row">
                <div class="col-md-12">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 25%">
                                        <table style="width: 100%;">
                                            ...
                                            <td class="btmBorder" style="width: 80%;font-size: 12px;border-top:none !important;border-right:none !important;text-align: right">{{$data->payment}}</td>
                                        </table>
                                    </td>
                                </tr>
                                                            </table>
                    ...
                    <div class="row" style="margin-bottom: 90px;margin-left: 4px">
                        <div class="col-xs-12"><b>Amount (in Words) : </b> {{convertToWords($data->payment)}}
                        </div>
                    </div>
